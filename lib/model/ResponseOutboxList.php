...
/**
 * ResponseOutboxList Class Doc Comment
 *
 * @category Class
 * @description Response containing a list of outbox objects
 * @package  faxplus
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ResponseOutboxList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'response_OutboxList';
     ...
     * Sets records
     *
     * @param \faxplus\model\Outbox[] $records records
     *
     * @return $this
     */
