...
/**
 * OutboxFileChanges Class Doc Comment
 *
 * @category Class
 * @package  faxplus
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OutboxFileChanges implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Outbox_file_changes';
    ...
    protected static $swaggerTypes = [
        'files' => '\faxplus\model\OutboxFiles[]',
        'at' => 'string'
    ];
     ...
     * Gets files
     *
     * @return \faxplus\model\OutboxFiles[]
     */
     ...
     * Sets files
     *
     * @param \faxplus\model\OutboxFiles[] $files files
     *
     * @return $this
     */
